<div class="flex md:order-2">
    ...
    <div class="relative hidden md:block">
      ...
      <form action="{{ route('dashboard') }}" method="GET">
        <input type="text" name="search" placeholder="Cari data siswa..." class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
        <input type="submit" value="CARI" class="hidden">
      </form>
    </div>
</div>